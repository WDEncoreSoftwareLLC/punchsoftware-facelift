...
<body>
    <?php include_once('b2c_relatedsites.php'); ?>
    ...
    <div id="B2C_MasterPage">
        ...
        <div id="B2C_Header">
            <div id="heading_links">
                ...
                <div class="login"><span class="loginText"><a href="signin.aspx">Login</a></span></div>
            </div>
        ...
        <div id="B2C_Seperator">
            ...
            <div id="seperatorHTMLContent1"></div>
        </div>
		...
		<div id="B2C_PageContent">
            <div id="B2C_SidebarLeft">
                ...
                <div id="sidebarLeftHTMLContent1"></div>
                        ...
                        <ul class="product_listing">
                            <li class="product_listing_item">
                                ...
                                <div class="product_listing_name">
                                    <a id="SidebarLeftBestSellersControl_rptProductListing_ctl01_lnkProductName" href="p-145-punch-home-landscape-design-essentials-v19.aspx">Punch! Home &amp; Landscape Design Essentials v19</a>
                                </div>
                            ...
                            <li class="product_listing_item">
                                <div class="product_listing_image"></div>
                                <div class="product_listing_name">
                                    <a id="SidebarLeftBestSellersControl_rptProductListing_ctl03_lnkProductName" href="p-138-punch-landscape-design-for-mac-v19.aspx">Punch! Landscape Design for Mac v19</a>
                                </div>
                                <div class="product_listing_description"></div>
                            </li>
                            ...
                            <li class="product_listing_item">
                                <div class="product_listing_image"></div>
                                <div class="product_listing_name">
                                    <a id="SidebarLeftBestSellersControl_rptProductListing_ctl04_lnkProductName" href="p-148-punch-home-landscape-design-architectural-series-v19.aspx">Punch! Home &amp; Landscape Design Architectural Series v19</a>
                                </div>
                                <div class="product_listing_description"></div>
                            </li>
                            ...
                            <li class="product_listing_item">
                                <div class="product_listing_image"></div>
                                <div class="product_listing_name">
                                    <a id="SidebarLeftBestSellersControl_rptProductListing_ctl05_lnkProductName" href="p-146-punch-home-landscape-design-premium-v19.aspx">Punch! Home &amp; Landscape Design Premium v19</a>
                                </div>
                                <div class="product_listing_description"></div>
                            </li>
                            <li class="product_listing_item">
                                <div class="product_listing_image"></div>
                                <div class="product_listing_name">
                                    <a id="SidebarLeftBestSellersControl_rptProductListing_ctl06_lnkProductName" href="p-141-punch-home-design-studio-complete-for-mac-v19.aspx">Punch! Home Design Studio Complete for Mac v19</a>
                                </div>
                                <div class="product_listing_description"></div>
                            </li>
                            <li class="product_listing_item">
                                <div class="product_listing_image"></div>
                                <div class="product_listing_name">
                                    <a id="SidebarLeftBestSellersControl_rptProductListing_ctl07_lnkProductName" href="p-142-punch-home-design-studio-for-mac-v19.aspx">Punch! Home Design Studio for Mac v19</a>
                                </div>
                                <div class="product_listing_description"></div>
                            </li>
                            <li class="product_listing_item">
                                <div class="product_listing_image"></div>
                                <div class="product_listing_name">
                                    <a id="SidebarLeftBestSellersControl_rptProductListing_ctl08_lnkProductName" href="p-140-punch-home-design-studio-essentials-for-mac-v19.aspx">Punch! Home Design Studio Essentials for Mac v19</a>
                                </div>
                                <div class="product_listing_description"></div>
                            </li>
                            <li class="product_listing_item">
                                <div class="product_listing_image"></div>
                                <div class="product_listing_name">
                                    <a id="SidebarLeftBestSellersControl_rptProductListing_ctl09_lnkProductName" href="p-143-punch-landscape-deck-patio-v19.aspx">Punch! Landscape, Deck &amp; Patio v19</a>
                                </div>
                                <div class="product_listing_description"></div>
                            </li>
                        </ul>
